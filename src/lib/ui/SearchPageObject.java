...
public class SearchPageObject extends MainPageObject{
    ...
    public void typeSearchLine(String search){
        this.waitForElementAndSendKey(By.xpath(SEARCH_INPUT),"Java","Cannot find and type into search input",5);
    }
    public void waitForSearchResult(String substring){//String substring
        String searchResultXpath = getResultSearchElement(substring);
        this.waitForElementPresent(By.xpath(searchResultXpath),"Cannot find search result with substring ",25);
    }
}
